                ...
                <div className="py-4 flex justify-center">
                    <div className="flex flex-col items-center">
                        <div className="user-avatar">
                            <Image className="w-16 h-16 rounded-full ring-4 p-1 ring-gray-700" src="/src/assets/images/user.jpg" />
                        </div>
    ...
    return (
        <div className="w-full p-3 my-1 border-gray-200 bg-gray-100 rounded-xl dark:bg-gray-700">
            <div className="w-full h-full flex items-start">
                <Image className="w-10 h-10 mr-3 rounded-full ring-4 ring-gray-300 dark:ring-gray-500" src="/src/assets/images/user.jpg" />
